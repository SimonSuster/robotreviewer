...
class RationaleCNN:
    ...
    def build_RA_CNN_model(self):
        ...
        tokens_input = Input(name='input',
                            shape=(selfpreprocessor.max_doc_len, self.preprocessor.max_sent_len),
                            dtype='int32')
...
class Preprocessor:
    def __init__(self, max_features, max_sent_len, embedding_dims=200, wvs=None,
        ...
        log.debug('Tokenizer oov_token set as {}'.format(self.tokenzier.oov_token))
